document.getElementById("bio").innerHTML="İlker"
...
var engin = document.getElementById("engin").addEventListener("mouseover",rengiDegistir);

function rengiDegistir()
{
    document.getElementById("div1").style.color = "red";
    var isimElemanları  = document.getElementsByName("musteriAdi");
    isimElemanları[0].value = "Selahattin";
